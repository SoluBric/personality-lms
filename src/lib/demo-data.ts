...
export type Territory = 'Strengths' | 'Stress & Growth' | 'Fortification' | 'Team';
...
export const recommendations: Recommendation[] = [
  ...
  rec('emily', 'TM-T8-01', 'primary', 'team', "James's 8-led profile makes directness and challenge especially relevant to Emily's daily team context.", { type: 8, relationshipId: 'emily-james', teamId: 'atlas' }),
  rec('emily', 'TM-T4-01', 'supporting', 'team', "Helps Emily interpret Sophie's challenge and creative intensity without assuming it is relational conflict.", { type: 4, relationshipId: 'emily-sophie', teamId: 'atlas' }),
  rec('emily', 'TM-T5-01', 'supporting', 'team', "Helps Emily distinguish Thomas's processing and analytical distance from disengagement.", { type: 5, relationshipId: 'emily-thomas', teamId: 'atlas' }),
  ...
  rec('emily', 'TM-GEN-02', 'primary', 'team', "Especially relevant to Emily-James and to Team Atlas's need to make disagreement visible earlier.", { relationshipId: 'emily-james', teamId: 'atlas' }),
  ...
  rec('james', 'S8-01', 'primary', 'strengths', 'Refines natural directness into clear challenge that others can use.', { type: 8 }),
  rec('james', 'S8-02', 'primary', 'strengths', 'Develops speed and confidence without forcing premature closure.', { type: 8 }),
  rec('james', 'S8-03', 'supporting', 'strengths', 'Advanced use of authority, challenge and delegation.', { type: 8 }),
  rec('james', 'S3-01', 'supporting', 'strengths', 'Strengthens visible execution and outcome clarity.', { type: 3 }),
  rec('james', 'S1-01', 'supporting', 'strengths', 'Develops his standards signal into more explicit quality criteria.', { type: 1 }),
  rec('james', 'SG-S8-01', 'primary', 'stress-growth', 'Recognises guarded distance after challenge.', { type: 8 }),
  rec('james', 'SG-S8-02', 'supporting', 'stress-growth', 'Provides a deliberate route back into collaboration.', { type: 8 }),
  rec('james', 'SG-G8-01', 'primary', 'stress-growth', 'Uses Type 2-associated empathy and receptivity as a growth resource.', { type: 8 }),
  rec('james', 'SG-G8-02', 'supporting', 'stress-growth', 'Broadens strength by allowing help and shared ownership.', { type: 8 }),
  rec('james', 'SG-GEN-02', 'supporting', 'stress-growth', 'General regulation under intensity.'),
  rec('james', 'F9-01', 'primary', 'fortification', 'Adds listening and integration before decisive closure.', { type: 9 }),
  rec('james', 'F9-02', 'supporting', 'fortification', 'Builds the ability to close with real participation rather than assumed agreement.', { type: 9 }),
  rec('james', 'F2-02', 'supporting', 'fortification', 'Develops relational influence beyond authority and urgency.', { type: 2 }),
  rec('james', 'F5-01', 'explore', 'fortification', 'Adds deliberate distance before immediate action.', { type: 5 }),
  rec('james', 'TM-T9-01', 'primary', 'team', 'Directly relevant to Emily.', { type: 9, relationshipId: 'emily-james', teamId: 'atlas' }),
  rec('james', 'TM-T4-01', 'supporting', 'team', 'Directly relevant to Sophie.', { type: 4, relationshipId: 'james-sophie', teamId: 'atlas' }),
  rec('james', 'TM-T5-01', 'supporting', 'team', 'Directly relevant to Thomas.', { type: 5, relationshipId: 'james-thomas', teamId: 'atlas' }),
  rec('james', 'TM-GEN-01', 'primary', 'team', 'Supports listening before moving to decision.', { teamId: 'atlas' }),
  rec('james', 'TM-GEN-02', 'primary', 'team', 'Makes disagreement productive and usable.', { teamId: 'atlas' }),
  rec('james', 'TM-GEN-03', 'supporting', 'team', 'Supports team decision closure after disagreement has been surfaced.', { teamId: 'atlas' }),
  rec('james', 'TM-GEN-04', 'supporting', 'team', 'Clarifies ownership so decisiveness does not become overreach.', { teamId: 'atlas' }),

  rec('sophie', 'S4-01', 'primary', 'strengths', 'Turns emotional and aesthetic sensitivity into usable creative information.', { type: 4 }),
  rec('sophie', 'S4-02', 'primary', 'strengths', 'Develops originality that remains collaborative.', { type: 4 }),
  rec('sophie', 'S7-01', 'supporting', 'strengths', 'Sharpens option generation into opportunity judgement.', { type: 7 }),
  rec('sophie', 'S7-02', 'supporting', 'strengths', 'Turns possibility into testable learning.', { type: 7 }),
  rec('sophie', 'S1-02', 'supporting', 'strengths', 'Develops quality standards without endless refinement.', { type: 1 }),
  rec('sophie', 'SG-S4-01', 'primary', 'stress-growth', 'Helps recognise when longing turns into over-attunement.', { type: 4 }),
  rec('sophie', 'SG-S4-02', 'supporting', 'stress-growth', 'Supports stopping the chase for reassurance under pressure.', { type: 4 }),
  rec('sophie', 'SG-G4-01', 'primary', 'stress-growth', 'Uses structure and standards as a growth resource.', { type: 4 }),
  rec('sophie', 'SG-G4-02', 'supporting', 'stress-growth', 'Builds discipline without flattening originality.', { type: 4 }),
  rec('sophie', 'SG-GEN-05', 'supporting', 'stress-growth', 'Supports steadier attention under load.'),
  rec('sophie', 'F3-01', 'primary', 'fortification', 'Adds clearer delivery ownership.', { type: 3 }),
  rec('sophie', 'F3-02', 'supporting', 'fortification', 'Makes progress information usable rather than threatening to identity.', { type: 3 }),
  rec('sophie', 'F5-01', 'supporting', 'fortification', 'Gives a more detached way to test assumptions.', { type: 5 }),
  rec('sophie', 'F8-01', 'supporting', 'fortification', 'Supports clear challenge and commitment points.', { type: 8 }),
  rec('sophie', 'TM-T9-01', 'primary', 'team', 'Directly relevant to Emily.', { type: 9, relationshipId: 'emily-sophie', teamId: 'atlas' }),
  rec('sophie', 'TM-T8-01', 'primary', 'team', 'Directly relevant to James.', { type: 8, relationshipId: 'james-sophie', teamId: 'atlas' }),
  rec('sophie', 'TM-T5-01', 'supporting', 'team', 'Directly relevant to Thomas.', { type: 5, relationshipId: 'sophie-thomas', teamId: 'atlas' }),
  rec('sophie', 'TM-GEN-05', 'primary', 'team', 'Helps feedback travel without flattening the work.', { teamId: 'atlas' }),
  rec('sophie', 'TM-GEN-03', 'supporting', 'team', 'Helps creative exploration move toward clear decision closure.', { teamId: 'atlas' }),
  rec('sophie', 'TM-GEN-08', 'supporting', 'team', 'Turns different perspectives into one plan.', { teamId: 'atlas' }),

  rec('thomas', 'S5-01', 'primary', 'strengths', 'Builds deep analysis into better practical questions.', { type: 5 }),
  rec('thomas', 'S5-02', 'primary', 'strengths', 'Turns evidence and models into strategic synthesis.', { type: 5 }),
  rec('thomas', 'S5-03', 'supporting', 'strengths', 'Translates expertise into influence under complexity.', { type: 5 }),
  rec('thomas', 'S6-01', 'supporting', 'strengths', 'Refines risk detection into proportionate challenge.', { type: 6 }),
  rec('thomas', 'S7-02', 'supporting', 'strengths', 'Turns scenario exploration into experiments.', { type: 7 }),
  rec('thomas', 'SG-S5-01', 'primary', 'stress-growth', 'Recognises when analysis scatters under pressure.', { type: 5 }),
  rec('thomas', 'SG-S5-02', 'supporting', 'stress-growth', 'Reduces option overload under pressure.', { type: 5 }),
  rec('thomas', 'SG-G5-01', 'primary', 'stress-growth', 'Practises action before certainty.', { type: 5 }),
  rec('thomas', 'SG-G5-02', 'supporting', 'stress-growth', 'Develops embodied decisiveness as a growth resource.', { type: 5 }),
  rec('thomas', 'SG-GEN-04', 'supporting', 'stress-growth', 'Supports decisions under uncertainty.'),
  rec('thomas', 'F3-01', 'primary', 'fortification', 'Makes ownership and action more visible.', { type: 3 }),
  rec('thomas', 'F3-02', 'supporting', 'fortification', 'Strengthens action-feedback loops.', { type: 3 }),
  rec('thomas', 'F8-01', 'supporting', 'fortification', 'Supports decisive expression before analysis is complete.', { type: 8 }),
  rec('thomas', 'F9-01', 'supporting', 'fortification', 'Broadens relational participation and integration.', { type: 9 }),
  rec('thomas', 'TM-T9-01', 'primary', 'team', 'Directly relevant to Emily.', { type: 9, relationshipId: 'emily-thomas', teamId: 'atlas' }),
  rec('thomas', 'TM-T8-01', 'primary', 'team', 'Directly relevant to James.', { type: 8, relationshipId: 'james-thomas', teamId: 'atlas' }),
  rec('thomas', 'TM-T4-01', 'supporting', 'team', 'Directly relevant to Sophie.', { type: 4, relationshipId: 'sophie-thomas', teamId: 'atlas' }),
  rec('thomas', 'TM-GEN-06', 'primary', 'team', 'Supports working across different operating styles.', { teamId: 'atlas' }),
  rec('thomas', 'TM-GEN-03', 'supporting', 'team', 'Helps close decisions from rich input.', { teamId: 'atlas' }),
  rec('thomas', 'TM-GEN-08', 'supporting', 'team', 'Turns different perspectives into one plan.', { teamId: 'atlas' }),

  rec('sarah', 'S9-01', 'primary', 'strengths', 'Builds calm synthesis and listening into deliberate capability.', { type: 9 }),
  rec('sarah', 'S9-02', 'supporting', 'strengths', 'Develops mediation that surfaces difference.', { type: 9 }),
  rec('sarah', 'S5-02', 'primary', 'strengths', 'Turns internal synthesis into earlier, clearer contribution.', { type: 5 }),
  rec('sarah', 'S5-03', 'supporting', 'strengths', 'Builds expert communication under complexity.', { type: 5 }),
  rec('sarah', 'S3-01', 'supporting', 'strengths', 'Builds execution visibility.', { type: 3 }),
  rec('sarah', 'SG-S9-01', 'primary', 'stress-growth', 'Recognises when calm becomes worry or hidden vigilance.', { type: 9 }),
  rec('sarah', 'SG-S9-02', 'supporting', 'stress-growth', 'Moves from reassurance-seeking to clearer decisions.', { type: 9 }),
  rec('sarah', 'SG-G9-01', 'primary', 'stress-growth', 'Uses agency and visibility as a growth resource.', { type: 9 }),
  rec('sarah', 'SG-G9-02', 'supporting', 'stress-growth', 'Builds agency through small commitments.', { type: 9 }),
  rec('sarah', 'SG-GEN-04', 'supporting', 'stress-growth', 'Supports decisions under uncertainty.'),
  rec('sarah', 'F8-01', 'primary', 'fortification', 'Helps make challenge visible earlier.', { type: 8 }),
  rec('sarah', 'F8-02', 'supporting', 'fortification', 'Supports earlier disagreement with Oliver.', { type: 8 }),
  rec('sarah', 'F2-01', 'supporting', 'fortification', 'Creates more visible relational communication rather than private synthesis.', { type: 2 }),
  rec('sarah', 'F1-01', 'explore', 'fortification', 'Supports explicit delivery constraints.', { type: 1 }),
  rec('sarah', 'TM-T3-01', 'primary', 'team', 'Oliver shares Type 3 with Sarah and leads with it.', { type: 3, relationshipId: 'sarah-oliver', teamId: 'beacon' }),
  rec('sarah', 'TM-T7-01', 'supporting', 'team', "Directly relevant to Oliver's opportunity orientation.", { type: 7, relationshipId: 'sarah-oliver', teamId: 'beacon' }),
  rec('sarah', 'TM-T8-01', 'supporting', 'team', "Relevant to Oliver's assertive third signal.", { type: 8, relationshipId: 'sarah-oliver', teamId: 'beacon' }),
  rec('sarah', 'TM-GEN-03', 'primary', 'team', 'Supports timely decision closure.', { teamId: 'beacon' }),
  rec('sarah', 'TM-GEN-04', 'supporting', 'team', 'Clarifies ownership in the shared team route.', { teamId: 'beacon' }),
  rec('sarah', 'TM-GEN-07', 'supporting', 'team', 'Builds high-trust commitments for the small team.', { teamId: 'beacon' }),

  rec('oliver', 'S3-01', 'primary', 'strengths', 'Builds achievement energy into clear momentum.', { type: 3 }),
  rec('oliver', 'S3-02', 'primary', 'strengths', 'Develops sustainable high performance.', { type: 3 }),
  rec('oliver', 'S3-03', 'supporting', 'strengths', 'Uses visible progress to create commitment.', { type: 3 }),
  rec('oliver', 'S7-01', 'supporting', 'strengths', 'Sharpens opportunity scanning.', { type: 7 }),
  rec('oliver', 'S8-02', 'supporting', 'strengths', 'Calibrates decisive action.', { type: 8 }),
  rec('oliver', 'SG-S3-01', 'primary', 'stress-growth', 'Recognises performance exhaustion and disengagement.', { type: 3 }),
  rec('oliver', 'SG-S3-02', 'supporting', 'stress-growth', 'Supports re-engagement after performance exhaustion.', { type: 3 }),
  rec('oliver', 'SG-G3-01', 'primary', 'stress-growth', 'Adds risk and shared preparation before momentum runs ahead.', { type: 3 }),
  rec('oliver', 'SG-G3-02', 'supporting', 'stress-growth', 'Builds trust through shared preparation.', { type: 3 }),
  rec('oliver', 'SG-GEN-04', 'supporting', 'stress-growth', 'Supports decisions under uncertainty.'),
  rec('oliver', 'F6-01', 'primary', 'fortification', 'Adds more deliberate challenge before commitments are made.', { type: 6 }),
  rec('oliver', 'F6-02', 'supporting', 'fortification', 'Supports credible commercial judgement.', { type: 6 }),
  rec('oliver', 'F9-01', 'supporting', 'fortification', 'Increases listening and space for reservations.', { type: 9 }),
  rec('oliver', 'F5-01', 'explore', 'fortification', 'Helps test opportunity before momentum becomes commitment.', { type: 5 }),
  rec('oliver', 'TM-T9-01', 'primary', 'team', "Sarah's primary pattern.", { type: 9, relationshipId: 'sarah-oliver', teamId: 'beacon' }),
  rec('oliver', 'TM-T5-01', 'supporting', 'team', "Sarah's analytical supporting signal.", { type: 5, relationshipId: 'sarah-oliver', teamId: 'beacon' }),
  rec('oliver', 'TM-GEN-01', 'primary', 'team', 'Supports listening before leading in the shared team route.', { teamId: 'beacon' }),
  rec('oliver', 'TM-GEN-03', 'supporting', 'team', 'Supports team decision closure.', { teamId: 'beacon' }),
  rec('oliver', 'TM-GEN-07', 'supporting', 'team', 'Builds commitment practices for the small team.', { teamId: 'beacon' })
];
